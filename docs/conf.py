# docs/conf.py — ArrayKit (Sphinx 8.x / Python 3.13, Book Theme)
from __future__ import annotations
import os, datetime
from subprocess import Popen, PIPE

project   = "infocyph/ArrayKit"
author    = "Infocyph"
...
html_theme_options = {
    "repository_url": "https://github.com/infocyph/ArrayKit",
...
html_title       = f"ArrayKit Manual ({version})"
